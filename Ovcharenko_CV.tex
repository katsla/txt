...
\section{Skills}
    \cvitem{Computer languages}{Lua, Bash, R, Python, Perl, SQL, regular expressions, XML, HTML}
%    \cvitem{Tools}{Flyspray, Chili Project, CVS, Git, SSH}
%    \cvitem{Systems}{Linux, Windows, MacOS}
    \cvitem{IT tools}{Linux, PostgreSQL, Git, CVS, Jenkins}
    \cvitem{Soft skills}{team training and managment, conflict managment, customer support}



\section{Experience}

\cventry{October~2015 -- present}{Senior Spam Analyst}{Kaspersky Lab}{remote work}{} {
    \responsibilities {
...
\cventry{August~2005 -- December~2005}{QA engineer}{Vocord global telecommunication}{Moscow}{} {
    \responsibilities {
        \item Load and functional testing.
    }
}

\cventry{September~2001 -- April~2003}{Teacher of physics and mathematics}{Secondary school \#4}{Moscow}{} {
    \responsibilities {
...
\cventry{2016 -- 2017}{Graduate Diploma in IT}{Whitireia New Zealand}{}{}{}
...
\section{Interests}
Online learning, video editing, rafting, boardgames, LARP
...
\section{References}
 \begin{cvcolumns}
   \cvcolumn{ \\}{\begin{itemize}
		\item Dmitry Shiltsov \\Developer \\Powershop New Zealand \\d.shiltsov@gmail.com \\+64 21 1749483 \\
                \item Ekaterina Willamow \\Researcher in computational linguistics \\The Univercity of Melbourne \\ekaterina.vylomova@fulbrightmail.org \\+61 47 8776075 
%		\item Evgeny Smirnov \\Head of Content Filtering Research\\Kaspersky Lab \\Evgeny.Smirnov@kaspersky.com 
			\end{itemize}}
