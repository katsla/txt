...
% \title{Developer}
\address{6, Volokolamskoe sh., apt. 123}{Moscow}{Russia}
...
\section{Computer skills}
    \cvitem{Computer languages}{Lua, Bash, Python, R, regular expressions, XML, HTML}
    \cvitem{Development Tools}{Flyspray, CVS, Git}
    \cvitem{Systems}{Linux, Windows, MacOS}
    \cvitem{Soft Skills}{managing group of 15 people, customer support, teaching mathematics and physics to students}
...
% \bibliography{Shiltsov_moderncv}


\section{Interests}
Unix, open source, \href{http://en.wikipedia.org/wiki/Getting_Things_Done}{GTD}, data extraction, data mining, automating routines, keeping users happy.
