...
\cventry{May~2012 -- present}{Head of heuristic analysis group}{Kaspersky Lab}{Moscow}{} {
    \responsibilities {
        ...
        \item Guiding antispam engine developers. %Странно звучит
        ...
        \item Blacklisting IPs by using user-based statistics (SQL). %Всё равно не понятно.
    ...
    \achievements {        % а скриптов каких-нибудь сюда не напихать?
        ...
        \begin{itemize}
            ...
            \item applying the latest approaches from IT conferences and academic papers; %Тебя сразу спросят, на каких конференциях была?
